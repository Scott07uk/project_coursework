#https://github.com/yiskw713/ScoreCAM/blob/master/cam.py
...
#
# These functions were taken from https://github.com/yiskw713/ScoreCAM/blob/master/utils/visualize.py
#
# Only the needed functions were included here to reduce the size of the codebase
#
...
def visualize(img, cam):
    ...
    cam = 255 * cam.squeeze()
    heatmap = cv2.applyColorMap(numpy.uint8(cam), cv2.COLORMAP_JET)
...
#
# These classes are taken from https://github.com/yiskw713/ScoreCAM/blob/master/cam.py
#
